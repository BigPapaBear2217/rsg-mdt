...
-- Get MDT Data
RSGCore.Functions.CreateCallback('rsg-mdt:server:getMDTData', function(source, cb)
    local src = source
...
-- Search Persons
RSGCore.Functions.CreateCallback('rsg-mdt:server:searchPersons', function(source, cb, query)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
-- Search Vehicles
RSGCore.Functions.CreateCallback('rsg-mdt:server:searchVehicles', function(source, cb, query)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
-- Search Horses
RSGCore.Functions.CreateCallback('rsg-mdt:server:searchHorses', function(source, cb, query)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
-- Get Person Details
RSGCore.Functions.CreateCallback('rsg-mdt:server:getPersonDetails', function(source, cb, citizenid)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
-- Get Vehicle Details
RSGCore.Functions.CreateCallback('rsg-mdt:server:getVehicleDetails', function(source, cb, plate)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
-- Get Horse Details
RSGCore.Functions.CreateCallback('rsg-mdt:server:getHorseDetails', function(source, cb, horseid)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
RSGCore.Functions.CreateCallback('rsg-mdt:server:getHorseBountyAlerts', function(source, cb, horseid)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
-- Save Person
RSGCore.Functions.CreateCallback('rsg-mdt:server:savePerson', function(source, cb, person)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
-- Save Vehicle
RSGCore.Functions.CreateCallback('rsg-mdt:server:saveVehicle', function(source, cb, vehicle)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
-- Create Warrant
RSGCore.Functions.CreateCallback('rsg-mdt:server:createWarrant', function(source, cb, warrant)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
-- Create Report
RSGCore.Functions.CreateCallback('rsg-mdt:server:createReport', function(source, cb, report)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
-- Create Citation
RSGCore.Functions.CreateCallback('rsg-mdt:server:createCitation', function(source, cb, citation)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
