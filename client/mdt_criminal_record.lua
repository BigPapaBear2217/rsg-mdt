...
------------------------------------------
RegisterNetEvent('rsg-mdt:client:viewCriminalRecordWithAdd', function(data)
    ...
    table.insert(options, {
        ...
        event = 'rsg-mdt:client:addCriminalRecord',
...
-- Add Criminal Record
------------------------------------------
RegisterNetEvent('rsg-mdt:client:addCriminalRecord', function(data)
    ...
    if input then
        ...
        if charges and charges ~= '' then
            ...
            RSGCore.Functions.TriggerCallback('rsg-mdt:server:createCriminalRecord', function(success)
                if success then
                    lib.notify({
                        title = 'Record Added',
