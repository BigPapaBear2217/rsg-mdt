...
------------------------------------------
RegisterNetEvent('rsg-mdt:client:viewCitationsWithPay', function(data)
        ...
        for i = 1, #personData.citations do
            ...
            if isPayable then
                table.insert(options, {
                    ...
                    event = 'rsg-mdt:client:payCitation',
...
-- Pay Citation
------------------------------------------
RegisterNetEvent('rsg-mdt:client:payCitation', function(data)
    ...
    if alert == 'confirm' then
        RSGCore.Functions.TriggerCallback('rsg-mdt:server:payCitation', function(success)
            if success then
                lib.notify({
