...
------------------------------------------
RSGCore.Functions.CreateCallback('rsg-mdt:server:getTelegrams', function(source, cb)
    local src = source
...
------------------------------------------
RSGCore.Functions.CreateCallback('rsg-mdt:server:markTelegramAsRead', function(source, cb, telegramId)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
