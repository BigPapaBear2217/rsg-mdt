...
-- Create Bounty Alert
------------------------------------------
RSGCore.Functions.CreateCallback('rsg-mdt:server:createBountyAlert', function(source, cb, alertData)
    local src = source
...
------------------------------------------
RSGCore.Functions.CreateCallback('rsg-mdt:server:getActiveBountyAlerts', function(source, cb)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
------------------------------------------
RSGCore.Functions.CreateCallback('rsg-mdt:server:getPersonBountyAlerts', function(source, cb, citizenid)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
-- Claim Bounty Alert
------------------------------------------
RSGCore.Functions.CreateCallback('rsg-mdt:server:claimBountyAlert', function(source, cb, alertId)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
------------------------------------------
RSGCore.Functions.CreateCallback('rsg-mdt:server:updateBountyAlertStatus', function(source, cb, alertId, status)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
